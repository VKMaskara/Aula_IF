# PEGUE O SALARIO DE UM FUNCIONARIO, SE GANHAR MENOS DE 1.200,00 DE AUMENTO DE 151,00, SE TIVER FILHOS GANHA 200,00 POR FILHO
#AUTOR: VITOR KAUÊ
#DATA: 04/09/2025
...
if salario <= 1200 :  # Verifica se o salário é menor que 1200
    aumento += 151  # Adiciona 151 ao aumento se o salário for menor que 1200
else:
    aumento += 0  # Não adiciona nada ao aumento se o salário for 1200 ou mais

if filhos > 0 :  # Verifica se o funcionário tem filhos
    aumento += filhos * 200  # Adiciona 200 por cada filho ao aumento
else:
    aumento += 0 # Não adiciona nada ao aumento se não tiver filhos
